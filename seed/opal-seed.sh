...
opal rest -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -m POST /projects --content-type "application/json" < seed/project-mica.json
opal rest -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -m POST /projects --content-type "application/json" < seed/project-CLSA.json
opal rest -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -m POST /projects --content-type "application/json" < seed/project-CLS.json
opal rest -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -m POST /projects --content-type "application/json" < seed/project-LBLS.json
opal rest -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -m POST /projects --content-type "application/json" < seed/project-ULSAM.json

echo "Uploading data files..."
opal file -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -up seed/data-mica.zip /tmp
opal file -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -up seed/data-CLS.zip /tmp
opal file -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -up seed/data-CLSA.zip /tmp
opal file -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -up seed/data-ULSAM.zip /tmp
opal file -o https://$OPAL_HOST:$OPAL_PORT -u administrator -p password -up seed/data-LBLS.zip /tmp
